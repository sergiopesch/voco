    ...
    fn cached_update_check_round_trips() {
        let cache = CachedUpdateCheck {
            ...
            state: UpdateCheckState {
                ...
                current_version: Some("2026.0.2".to_string()),
                latest_release: Some(ReleaseInfo {
                    version: "2026.0.3-beta.1".to_string(),
                    name: "VOCO 2026.0.3 beta 1".to_string(),
                    url:
                        "https://github.com/sergiopesch/voco/releases/tag/voco.2026.0.3-beta.1"
                            .to_string(),
