...
lesson(
    ...
    [
        ...
        ("Fit the available CPUs", "A two-core VM took 35.37 seconds to warm a four-thread recognizer, exceeding startup limits. Two threads took 1.53 seconds in a controlled check. The candidate now caps its default at the available CPUs, up to four; accuracy and desktop tests must accompany that change."),
