...
lesson(
    ...
    "These are development experiments, not a released universal Linux installer. The Omarchy long-session result uses virtual audio and one GTK recipient. Physical microphones, other default desktops and the wider application matrix still need their own evidence.",
