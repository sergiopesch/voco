...
Open **http://127.0.0.1:8785**. Stop with Ctrl+C. No build, npm install, account, API key or internet connection is needed to study. The code tour follows the 2026.0.39 application snapshot. A separately dated TypeSafe chapter explains the later .41 evaluation without changing that source snapshot. The VOCO checkout must contain commit `fb957ff052547c24be92265b6b5343a4c29aff4b` (2026.0.39).
