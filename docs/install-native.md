...
Ubuntu/Debian packages are **2026.0.44**. Fedora, openSUSE and Arch/Omarchy packages
...
| --- | --- | --- |
| Ubuntu, Debian, Mint | `voco_2026.0.44_amd64.deb` | Resolved by apt |
...
```bash
sudo apt install ./voco_2026.0.44_amd64.deb
```
