...
Historical design evidence for the September 5 build. Its eight-page settings UI
was superseded by the [dictation-only candidate](../release-candidate.md). Paths
and test counts below describe that earlier build, not current qualification.
