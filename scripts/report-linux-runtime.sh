...
print_row "Automatic text delivery" "Requires selected VOCO IBus source and verified field lease"
echo
echo "Compatibility helpers (not automatic dictation readiness):"
